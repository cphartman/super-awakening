...
CLOUDS_TILE_SIZE = 288
CLOUDS_TILE_CHUNK_COUNT = (CLOUDS_TILE_SIZE/CHUNK_SIZE)+1
CLOUDS_TILE_LAST_CHUNK_SIZE = CLOUDS_TILE_SIZE - (CLOUDS_TILE_SIZE/CHUNK_SIZE)*CHUNK_SIZE

CLOUDS_MAP_SIZE = 1024
CLOUDS_MAP_CHUNK_COUNT = (CLOUDS_MAP_SIZE/CHUNK_SIZE)+1
CLOUDS_MAP_LAST_CHUNK_SIZE = CLOUDS_MAP_SIZE - (CLOUDS_MAP_SIZE/CHUNK_SIZE)*CHUNK_SIZE